                      ...
                      <div class="row flex flex-wrap items-center h-[100dvh]">
                         <div class="w-full lg:w-1/2">
                            ...
                            <div class="flex flex-wrap space-y-3 md:space-y-0 md:space-x-4 items-center">
                                <a href="https://www.youtube.com/@StarWars" target="blank" class="w-full md:w-1/3 bg-[#CD3743] hover:bg-[#cd3743e7] py-3 rounded-full text-center text-white font-semibold flex justify-center items-center">
